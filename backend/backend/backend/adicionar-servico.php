...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' || !isset($_SESSION['usuario_id'])) {
    header('Location: ../adicionar-servico.html?erro=acesso');
    exit;
}
...
if ($titulo === '') {
    header('Location: ../adicionar-servico.html?erro=campos_vazios');
    exit;
}
...
header('Location: ../servicos.html?sucesso=os_criada');
exit;